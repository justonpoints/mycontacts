...
import contactData from 'components/contactApp/testData/contactDataFilter';
...
const ContactListView2 = (props) => {
    ...
    return (
      <div>
        ...
        <ContactListToolbar subtitle="" search="Sort by Name (A-Z), Filter by State with CA" existing={true} total={data.length} />
