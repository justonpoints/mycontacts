...
import contactData from 'components/contactApp/testData/contactDataLarge';
...
const ContactListView2 = (props) => {
    ...
    return (
      <div>
        ...
        <Paper color="secondary" style={{width:"95%",margin:"auto"}}>
          <ContactListToolbar total={data.length} />
          <hr/>
