...
import ContactCard from 'components/contactApp/components/ContactCardDynamic'
import sampleData from 'components/contactApp/testData/contactDataLargeDynamic';
