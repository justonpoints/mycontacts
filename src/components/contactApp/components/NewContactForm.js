      ...
      <Paper style={{width:"100%",maxWidth:1000,margin:"auto",padding:10}} component="form" id="contact-form">
        ...
        <Grid style={{padding:20,width:'100%'}} spacing={2} container justify="center" alignItems="center" direction="column">
          ...
          <Grid item style={{width:"100%",maxWidth:800}}>
              ...
              <div style={{marginTop:5}}>
                <TextField label="Tags" style={{width:"100%",marginBottom:5}} variant="outlined" name="tags" />
              </div>
          </Grid>
          ...
          <Grid item style={{width:"100%",maxWidth:800}}>
              <Typography variant="subtitle1">Address <div style={{float:"right"}}><IconButton><AddCircleIcon color="secondary"/></IconButton></div></Typography>
              <div style={{marginTop:5}}>
                <br/>
                <TextField label="Label" style={{width:"100%",marginBottom:5}} variant="outlined" name="address_label" />
          ...
          <Grid item style={{width:"100%",maxWidth:800}}>
              <Typography variant="subtitle1">Phone <div style={{float:"right"}}><IconButton><AddCircleIcon color="secondary"/></IconButton></div></Typography>
              <div style={{marginTop:5}}>
                <br/>
                <TextField label="Label" style={{width:"40%",marginBottom:5}} variant="outlined" name="phone_label" />
                <TextField label="Phone" style={{width:"60%",marginBottom:5}} variant="outlined" name="phone" />
              </div>
          </Grid>
          <Grid item style={{width:"100%",maxWidth:800}}>
              <Typography variant="subtitle1">Email <div style={{float:"right"}}><IconButton><AddCircleIcon color="secondary"/></IconButton></div></Typography>
              <div style={{marginTop:5}}>
                <br/>
                <TextField label="Label" style={{width:"40%",marginBottom:5}} variant="outlined" name="email_label" />
                <TextField label="Email" style={{width:"60%",marginBottom:5}} variant="outlined" name="email" />
              </div>
          </Grid>
          <Grid item style={{width:"100%",maxWidth:800}}>
              <Typography variant="subtitle1">Other Contacts <div style={{float:"right"}}><IconButton><AddCircleIcon color="secondary"/></IconButton></div></Typography>
              <div style={{marginTop:5}}>
                <br/>
                <TextField style={{width:"40%",marginBottom:5}} label="Label" variant="outlined" name="other_label" />
                <TextField style={{width:"60%",marginBottom:5}} label="Value" variant="outlined" name="value" />
              </div>
          </Grid>
